function getModifier(message = '') {
    ...
    var relevantLines = stackLines.filter(line =>
        line.includes('at ') &&
...
var skipProps = new Set([
    'Object', 'Array', 'String', 'Number', 'Boolean', 'Symbol', 'Error',
    'Proxy', 'Reflect', 'Promise', 'Date', 'RegExp',
    'Buffer', 'require', 'module', 'exports', '__filename', '__dirname',
    'console',
    'queueMicrotask',
    'WebAssembly', 'URL', 'URLSearchParams', 'TextEncoder', 'TextDecoder',
    'SharedArrayBuffer', 'FinalizationRegistry', 'WeakRef', 'WeakMap', 'WeakSet',
