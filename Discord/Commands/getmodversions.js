...
var log = new Utils.log.log(colors.green("Sandustry.bot.command.GetModVersions"), "./sandustry.bot.main.txt", true);
...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option
                .setName('modid')
                .setDescription('The ID of the mod you want to fetch versions for')
                .setRequired(true)),
    /**
    ...
    async execute(interaction) {
        ...
        log.log(`getting mod versions for ${interaction.options.getString('modid')}`)
        ...
        try {
            ...
            var embed = new EmbedBuilder()
                .setTitle(`Mod ID: ${modID} - Versions`)
                .setDescription(`This mod has ${modsList.length} version(s). Below is the version list:`)
                .setColor(0x00AAFF)
                .setTimestamp();
