			...
			return (
				...
				(t.html = function (e) {
					...
					if (e)
						return (
							...
							this.options.sanitize && ((e = this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])), (t.type = "paragraph"), (t.text = e), (t.tokens = this.lexer.inline(e))),
							t
						);
				}),
				(t.def = function (e) {
				...
				(t.reflink = function (e, t) {
					...
					if ((u = (u = this.rules.inline.reflink.exec(e)) || this.rules.inline.nolink.exec(e)))
						return (e = t[(e = (u[2] || u[1]).replace(/\s+/g, " ")).toLowerCase()]) ? m(u, e, u[0], this.lexer) : { type: "text", raw: (t = u[0].charAt(0)), text: t };
				}),
				...
				(t.inlineText = function (e, t) {
					...
					if (e)
						return (
							(t = this.lexer.state.inRawBlock ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])) : e[0]) : A(this.options.smartypants ? t(e[0]) : e[0])),
					...
					for (var u, n, r, i, s, l, o, a, D, c, h, p, f, g, F, A, k = "", d = e.length, C = 0; C < d; C++)
						if (
							...
							this.options.extensions &&
								...
								(!1 !== (A = this.options.extensions.renderers[a.type].call({ parser: this }, a)) || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(a.type)))
						)
							k += A || "";
						else
							switch (a.type) {
				...
				l =
					...
					function (e) {
						...
						if (((e.message += "\nPlease report this to https://github.com/markedjs/marked."), r))
							return ((t = "<p>An error occurred:</p><pre>" + A(e.message + "", !0) + "</pre>"), i ? Promise.resolve(t) : s ? void s(null, t) : t);
